...
- [x] **Phase 1: Scaffold + CI/CD** - Astro project wired to GitHub Pages with CNAME; placeholder page live at jcbmcn.com (completed 2026-04-01)
...
- [x] **Phase 3: Core Pages + Visual Design** - All page routes implemented; visual design discussed and applied (completed 2026-04-02)
- [x] **Phase 4: Search + Tag Filtering** - Fuse.js search and tag filter working on the blog listing page (completed 2026-04-02)
- [x] **Phase 5: SEO + Polish** - RSS feed and sitemap live; site production-ready (completed 2026-04-02)
...
- [x] 04-02-PLAN.md — Add search input, tag filter bar, serialized post data, and client-side filter script to posts/index.astro
...
Plans:
- [x] 05-01-PLAN.md — Install @astrojs/rss + create RSS endpoint; install @astrojs/sitemap integration
- [x] 05-02-PLAN.md — Add dark mode CSS token block to global.css; create SiteHeader.astro component
- [x] 05-03-PLAN.md — Wire SiteHeader + anti-flash script into BaseLayout.astro; create 404.astro page
...
|-------|----------------|--------|-----------|
| 1. Scaffold + CI/CD | 2/2 | Complete | 2026-04-01 |
| 2. Content Layer + Migration | 2/2 | Complete   | 2026-04-02 |
| 3. Core Pages + Visual Design | 3/3 | Complete   | 2026-04-02 |
| 4. Search + Tag Filtering | 2/2 | Complete | 2026-04-02 |
| 5. SEO + Polish | 3/3 | Complete | 2026-04-02 |
...
**Shipped:** 2026-04-02
**Delivered:** Full personal site rebuilt from Hugo to Astro 6 — 5 phases, 12 plans, 21 tasks.

**Key Decisions:**
- Astro 6 Content Layer API chosen over legacy content collections — modern glob loader pattern
- CSS custom properties (not Tailwind @theme) for color tokens — enables direct var() usage in component style blocks
- Fuse.js in dependencies (not devDependencies) — required at build time for Vite bundling
- npm chosen as package manager — withastro/action@v5 auto-detects from package-lock.json

**Tech Debt Incurred:**
- Dark mode toggle is Phase 5 deliverable but DES-01 as a "v2 requirement" — the toggle exists but full WCAG AA audit deferred

**All v1 requirements validated:**
INFRA-01, INFRA-02, INFRA-03, INFRA-04, INFRA-05, CONT-01, CONT-02, CONT-03, CONT-04, PAGE-01, PAGE-02, PAGE-03, PAGE-04, PAGE-05, PAGE-06, SRCH-01, SRCH-02, SEO-01, SEO-02
