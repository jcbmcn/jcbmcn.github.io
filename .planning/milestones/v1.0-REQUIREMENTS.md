...
- [x] **SRCH-02**: Blog listing page supports free-text search across post titles, tags, and excerpts via Fuse.js (with `ignoreLocation: true`)

### SEO

- [x] **SEO-01**: RSS feed available at `/rss.xml` listing all published posts
- [x] **SEO-02**: `sitemap.xml` generated at build time
